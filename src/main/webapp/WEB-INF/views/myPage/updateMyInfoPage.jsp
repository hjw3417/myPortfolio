      ...
      <section class="updateMyInfo">
        ...
        <div>
          <form name="updateMyInfo" method="post" action="update" enctype="utf-8">
            ...
            <div>
              <input type="password" name="update_pw_con" size="20" minlength="9" maxlength="20" placeholder="비밀번호를 확인해주세요.">
            </div>
            <div>
              <input type="text" name="update_name" placeholder="이름을 입력해주세요." disabled>
            </div>
            <div>
            ...
            <div>
              <input type="text" name="update_roadAddress" id="roadAddress" placeholder="도로명주소">
              <input type="text" name="update_jibunAddress" id="jibunAddress" placeholder="지번주소">
            </div>
            <div>
              <input type="text" name="update_detailAddress" id="detailAddress" placeholder="상세주소를 입력해주세요.">
            </div>
            <div>
              <input type="email" name="update_email" placeholder="이메일 주소를 입력해주세요.">
            </div>
            <div>
              <input type="text" name="update_phone" size="11" maxlength="11" placeholder="휴대폰 번호를 입력해주세요.">
            </div>
            <div>
